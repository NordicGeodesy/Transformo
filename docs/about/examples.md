...
a specific layout that aligns with the pipeline architecture of Transformo. The configuration
...
In the following sections aspects of Transformo is demonstrated by examples of configuration
